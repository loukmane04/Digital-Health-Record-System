...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Request a doctor account");
        ...
        jPanel2.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 460, 570, -1));
...
colse.addActionListener(new java.awt.event.ActionListener() {
    ...
    jPanel2.add(fialed_login, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 451, 400, 40));
    ...
    jLabel8.setText("Hello! Let's start your workday.");
    jPanel2.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(-2, 180, 570, -1));
    ...
    private void LoginBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_LoginBtnActionPerformed
             ...
             function.login(Email,Password,fialed_login);
             ///if login failed login jlabel
    ...
    private static void openRegisterFrame() {
